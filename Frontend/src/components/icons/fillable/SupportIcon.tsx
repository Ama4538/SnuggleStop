...
const SupportIcon: React.FC<FillableIconProps> = ({ isFilled, fill, stroke, strokeWidth, height, ...props }) => {
    return (
        <svg
            {...props}
        ...
        >
            ...
            <g id="SVGRepo_iconCarrier" transform="scale(0.90) translate(30, 50)">
            <g>
